...
static void bond_loop(const struct bt_bond_info *info, void *data)
{
...
static void bt_ready(void)
{
	...
	bt_foreach_bond(BT_ID_DEFAULT, bond_loop, &bond_count);
...
{
	printk("Pairing completed. Reseting in 5 seconds...\n");
